...
// ddrace.ru settings
MACRO_CONFIG_STR(SvGameTypeName, sv_game_type_name, 256, "DDraceNetwork", CFGFLAG_SERVER, "Game Type Name")
MACRO_CONFIG_STR(SvGameTypeTestName, sv_game_type_test_name, 256, "TestDDraceNetwork", CFGFLAG_SERVER, "Game Type Test Name")

/*
 * Add config variables for mods below this comment to avoid merge conflicts.
 */

MACRO_CONFIG_INT(ClChatSteller, cl_chat_steller, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_INSENSITIVE, "Enable chat steller")
MACRO_CONFIG_INT(ClChatNameSteller, cl_chat_name_steller, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_INSENSITIVE, "Enable chat name steller")
MACRO_CONFIG_INT(ClChatSkinSteller, cl_chat_skin_steller, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_INSENSITIVE, "Enable chat skin steller")
MACRO_CONFIG_INT(ClChatAD, cl_chat_ad, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_INSENSITIVE, "Enable chat AD")

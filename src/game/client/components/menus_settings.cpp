...
void CMenus::RenderSettings(CUIRect MainView)
{
	...
	else if(g_Config.m_UiSettingsPage == SETTINGS_DLC)
	{
		GameClient()->m_MenuBackground.ChangePosition(CMenuBackground::POS_SETTINGS_DLC);
		RenderSettingsDLC(MainView);
	}
	else
	{
...
void CMenus::RenderSettingsAppearance(CUIRect MainView)
{
	...
	else if(s_CurTab == APPEARANCE_TAB_CHAT)
	{
		...
		// Set preview lines
		{
			...
			str_format(aLineBuilder, sizeof(aLineBuilder), "%s подключился", aBuf);
